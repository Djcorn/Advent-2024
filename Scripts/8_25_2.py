...
def func():
    ...
    if connected[shortest_1] and connected[shortest_2]:
        ...
        if index1 < index2:
            ...
            new_list.pop(index2)
        if index1 > index2:
            for i in new_list[index1]:
                new_list[index2].append(i)
            new_list.pop(index1)
    ...
    print(len(new_list))
    if len((new_list[0])) == 1000:
        print(fresh_array[shortest_1])
        print(fresh_array[shortest_2])
        print(fresh_array[shortest_1][0]*fresh_array[shortest_2][0])
        print(new_list)
        done = True
        return done
done = False
...
print(shortest_list)
if shortest_list == sorted(shortest_list):
    print(True)
